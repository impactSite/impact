...
if (strlen($arResult["ERROR_MESSAGE"]) <= 0)
{
	...
	?>
		<div class="impact_basket">
			<span class="multiplicity">товар отгружается согласно кратности транспортной упаковки, перед отправкой заказа нажмите кнопку "кратность"</span>
