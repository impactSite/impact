...
<form action="<?=POST_FORM_ACTION_URI?>" method="POST">
	...
	<?=bitrix_sessid_post()?>
		...
		<div class="mf-captcha">
			<div class="mf-text">Добавить картинку</div>
			<a id="refresh_captcha" href="#">Выбрать</a>
			<input type="hidden" id="captcha_sid" name="captcha_sid" value="<?=$arResult["capCode"]?>">			
			<div id="captcha_container"><img src="/bitrix/tools/captcha.php?captcha_sid=<?=$arResult["capCode"]?>" alt="CAPTCHA" /></div>		
