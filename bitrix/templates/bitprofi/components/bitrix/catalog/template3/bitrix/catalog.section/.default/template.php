...
foreach ($arResult['ITEMS'] as $key => $arItem)
{
	...
	?><div class="bx_catalog_item_title"><a href="<? echo $arItem['DETAIL_PAGE_URL']; ?>" title="<? echo $productTitle; ?>"><? echo $productTitle; ?></a></div>
		<div class="bx_catalog_item_id_xml">Внешний код : <? echo  $arItem['XML_ID']; ?></div>
...
<?if(in_array($USER->GetId(),$arItem["PROPERTIES"]["F_USER"]["VALUE"])){
  ...
  <a href="#" class="catalog-item-fav favorite_check<?=$check?>" data-id="<?=$arItem['ID']?>">В избранное</a>
  <div id="favorit_label"> <?=$val?></div>		
			<?
